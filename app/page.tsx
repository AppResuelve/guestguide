...
export default async function HomePage() {
  ...
  return (
    <div
      ...
      className="min-h-screen bg-white text-[#20241f]"
    >
      ...
      <div className="pt-16 sm:pt-20 pb-6 px-7 text-center">
        <h1 className="text-2xl sm:text-3xl font-normal text-brand-primary">
          {theme.hotelName}
        </h1>
        <p className="mt-2 text-sm text-[#6b6858]">
          Teléfonos útiles durante tu estadía — tocá un contacto para llamar o
          escribir
        </p>
      </div>
